...
class WorkBookHelper:
    ...
    @property
    def invalid_counter(self) -> int:  # useful if methods returns Optional types
        return self.__invalid_counter

    @property
    def number_of_sheet_checks(self) -> int:  # useful if methods returns Optional types
        return self.__number_of_sheet_checks

    @property
    def number_of_cell_name_checks(self) -> int:  # useful if methods returns Optional types
        return self.__number_of_sheet_checks

    def check_sheet(self, sheet_name: str) -> xw.main.Sheet:
    ...
    def check_cell_name(self, cell_name: str) -> str:
        ...
        if cell_name in self.all_cell_names:
            ...
            raise Exception(f"{cell_name} 이름을 찾을 수 없습니다.")
